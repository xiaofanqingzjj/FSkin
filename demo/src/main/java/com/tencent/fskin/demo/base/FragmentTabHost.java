...
//        FragmentTabHostHelper.TabInfo newTab = null;
//        for (int i=0; i<mTabs.size(); i++) {
//            FragmentTabHostHelper.TabInfo tab = mTabs.get(i).tabInfo;
//            if (tabId == tab.tabId) {
//                newTab = tab;
//            }
//        }
...
//                ft.add(mContainerId, newTab.fragment, String.valueOf(newTab.tabId));
//            } else {
//                ft.show(newTab.fragment);
//            }
//            // 通知tab切换监听
...
//                if (mLastTab != null) {
//                    lastTab = mLastTab.tabId;
//                    lastFragment = mLastTab.fragment;
//                }
//                mOnTabChangeListener.onTabChanged(newTab.tabId, lastTab, newTab.fragment, lastFragment);
//            }
//
//        } else {
//            if (mOnFocusTabClick != null) {
//                //如果点击的是当前选中的tab
//                mOnFocusTabClick.onFocusTabClick(mLastTab.tabId, mLastTab.fragment);
//            }
//        }
//        mLastTab = newTab;
//        return ft;
